...
### B. Header & Navigation
- Availability status indicator pill with pulsing green light (`#10b981`).
- Navigation links (`Work [40]`, `Service [4]`, `Experience [9y+]`, `Contact`).
- Animated Theme Switcher with morphing sliding thumb, icon cues, and local storage persistence.
- Header CTA (`Let's Collaborate ↗`) triggering the Contact Modal.
